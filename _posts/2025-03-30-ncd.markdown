...
1. ⁠The Mid-Cambridge NCD is ~50% less likely to issue a *single* permit that adds at least 1 net housing unit in a given year than an equivalent Res C plot of land outside the NCD. 
