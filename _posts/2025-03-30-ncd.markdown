...
<div class="figure-container" style="max-width: 400px; margin: 0 auto; margin-bottom: 10px;">
  ...
  <figcaption style="text-align: center; font-style: plain; font-size: 0.9em;">Fig. 1 Housing units per square kilometer. Non-residential areas of the city are often adjacent to highways with poor walkability to necessities and amenities.</figcaption>
</div>
