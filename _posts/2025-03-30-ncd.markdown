...
<div class="figure-container" style="max-width: 400px; margin: 0 auto; margin-bottom: 10px;">
  ...
  <figcaption style="text-align: center; font-style: plain; font-size: 0.9em;">Fig. 1 Housing units per square kilometer. The focus of this analysis will be all housing that falls within the red ("In Residential") areas.</figcaption>
</div>
