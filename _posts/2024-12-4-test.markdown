...
`upper()` is a method of the string class. For this reason, this function can only be applied to instances of `String`.
...
In practice, this emphasis on functions and Julia's multiple dispatch system enable extremely portable code.
