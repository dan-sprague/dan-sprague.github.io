...
Therefore, we need to define an approximating density of a sequence $x$ and model parameters $\theta$, $\hat{p}(x \mid \theta)$, that minimizes the difference between natural language and our ability to approximate it
