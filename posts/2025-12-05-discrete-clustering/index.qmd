...
Code for this analysis can be found [here](https://github.com/dan-sprague/DirichletDiffusion/blob/main/mixture_modeling.jl).
...
![Simulated 3-component 2-dimensional Gaussian Mixture Model.](../../assets/images/sparsemax/demo.png)
...
| Function Call | Output Vector | Interpretation |
|---|---|---|
| `softmax([1, 2, 3])` | `[0.090, 0.245, 0.665]` | **Dense**: All clusters have mass. |
| `project_to_simplex([1, 2, 3])` | `[0.0, 0.0, 1.0]` | **Sparse**: Converges to a "hard" assignment (One-hot). |
| `project_to_simplex([1, 2.9, 3])` | `[0.0, 0.45, 0.55]` | **Mixture**: Sparse, but handles ambiguity. |
...
[Wang and Carreira-Perpiñán (2013)](https://arxiv.org/pdf/1309.1541) provide an interesting method for projecting any vector of reals onto a probability simplex. This projection has the fascinating property of being able to project — *differentiably* — to a one-hot vector.
...
![Heatmap comparison of learned weights. Note the noise in the Standard GMM vs. the sparsity in Stick-Breaking and Sparsemax.](../../assets/images/sparsemax/gmm_discrete_heatmap.png)
...
![Points colored by most likely cluster assignment with opacity indicating confidence of assignment.](../../assets/images/sparsemax/gmm_grid_comparison_final.png)
